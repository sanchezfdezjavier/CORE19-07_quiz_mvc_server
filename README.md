...
$
$ cd CORE19-07_quiz_mvc_server  ## Entrar en el directorio de trabajo del programa de test
$
...
$             ## El directorio de trabajo contiene ahora el fichero: CORE19-07_quiz_mvc_server.zip
```

El fichero `CORE19-07_quiz_mvc_server.zip` contiene los ficheros de la practica comprimidos y puede subirse a la plataforma para su evaluación.
